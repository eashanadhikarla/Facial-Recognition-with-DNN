# Facial Recognition with Deep-NN
...
## Problem Statement
The previous face verification statistical techniques such as PCA(Principle Component Analysis), EigenFace, EigenVector, FisherFace but explicitly defining the low dimentional face representations based on ratios of distance, area and angles. However explicitly defined representations are not accurate.
